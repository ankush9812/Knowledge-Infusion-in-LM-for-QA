...
import random
import evaluate
path_to_triplets="data/CWQ_Questions" # CHANGE PATH TO THE QA DATASET
...
model = BloomForCausalLM.from_pretrained("CWQ_output_Triplet_32/checkpoint-246346") # CHANGE PATH TO THE CHECKPOINT OF LINK PREDICTION FINETUNED BLOOM MODEL
...
args = TrainingArguments(
    output_dir="CWQ_output_QA_32_2e",
